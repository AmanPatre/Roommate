...
export default function SignInPage() {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            toast.error(e.message || 'Sign-in failed. Check your credentials.');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
            ...
            >
                ...
                <div style={{ textAlign: 'center', marginBottom: 32 }}>
                    ...
                    <h2 style={{ color: 'var(--text)', marginBottom: 4 }}>Welcome back</h2>
                    <p style={{ fontSize: 14, color: 'var(--text-muted)' }}>Sign in to continue your prep</p>
                </div>
                ...
                <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: 'var(--text-muted)' }}>
                    ...
                    <Link href="/sign-up" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 600 }}>
                        Sign Up
                    </Link>
                </p>
            </motion.div>
